...
public class Vehicle2 {
    ...
    public String name;
    public Integer nCrew;
    public Integer nWheels;
    ...
    public Integer nCrew() {
        ...
        System.out.println ("The vehicle is carrying " + nCrew + " passengers.");
        return (nCrew);
    }
    ...
    public Integer nWheels() {
        ...
        Scanner sc = new Scanner (System.in);
        nWheels = Integer.parseInt(sc.nextLine ());
        System.out.println ("The vehicle has " + nWheels + " Wheels.");
        return(nWheels);
    }
    ...
    public Date registrationDate() {
        ...
        System.out.println ("The registration date of the vehicle is: " + registrationDate + " ");
